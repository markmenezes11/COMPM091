...
parser.add_argument("--type", type=str, default="CoVe", help="What sentence embeddings to use (GloVe, CoVe_without_GloVe, InferSent, GloVe+InferSent or CoVe). For CoVe, [GloVe(w)CoVe(w)] embeddings will be used. The same is done for GloVe+InferSent. Sorry for the confusing names. For CoVe_without_GloVe, GloVe(w) will not be included.")
