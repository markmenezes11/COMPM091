...
parser = argparse.ArgumentParser(description='SentEval Evaluation of lower-cased GLoVe+CoVe Sentence Representations in the form [GLoVe(s)+CoVe(s) for each sentence s]')
