...
parser = argparse.ArgumentParser(description='SentEval Evaluation of lower-cased GLoVe+CoVe Sentence Representations in the form [GLoVe(w)+CoVe(w) for each word w in sentence]')
