...
for iteration in iterations:
    ...
    if params.mode == 0: # Full sweep (train + eval) on local machine
        ...
        p = Popen("qsub -cwd -o " + params.outputdir + "train_output.txt -e " + params.outputdir + "train_error.txt train_qsub_helper.sh " + params.singularitycommand + " python train.py" +
