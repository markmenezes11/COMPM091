...
def batcher(params, batch):
    ...
    for raw_sentence in batch:
        ...
        if len(sentence) > max_sent_len:
            print("Sentence had to be cut from " + str(len(sentence)) + " to " + str(max_sent_len))
...
transfer_tasks = ['TREC', 'MRPC', 'SNLI', 'SICKEntailment', 'SICKRelatedness', 'STSBenchmark', 'ImageCaptionRetrieval', 'STS12', 'STS13', 'STS14', 'STS15', 'STS16']
